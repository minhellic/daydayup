...
<!-- 引入包含负值的条形图js -->
<script type="text/javascript" src="${pageContext.request.contextPath}/js/charts/bar.js"></script>
</head>
<body>
	<div id="bar" style="min-width: 400px; height: 500px;"></div>
</body>
</html>